      ...
      {!isSubmitted ? (
        <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center' }}>
          <button
            ...
            style={{
              background: feedback === 'positive' ? 'rgba(72, 187, 120, 0.1)' : 'white',
              border: feedback === 'positive' ? '2px solid #48bb78' : '2px solid #e2e8f0',
              borderRadius: '50px',
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = '0 4px 12px rgba(72, 187, 120, 0.2)';
            }}
            onMouseLeave={(e) => {
          ...
          <button
            ...
            style={{
              background: feedback === 'negative' ? 'rgba(245, 101, 101, 0.1)' : 'white',
              border: feedback === 'negative' ? '2px solid #f56565' : '2px solid #e2e8f0',
              borderRadius: '50px',
              padding: '0.75rem 1.5rem',
              cursor: 'pointer',
              transition: 'all 0.2s ease',
